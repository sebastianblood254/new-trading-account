...
import { DerivWSTradingService } from '@/services/trading.service';
...
class APIBase {
    ...
    getActiveSymbols = async () => {
        ...
        try {
            ...
            const activeSymbols = await DerivWSTradingService.fetchActiveSymbols();

            const apiResult = { active_symbols: activeSymbols };
